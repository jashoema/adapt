"""
System and instruction prompts for the hello-world agent and network fault agent.
"""

HELLO_WORLD_SYSTEM_PROMPT = (
    "You are a friendly AI assistant. Whenever the user says anything, "
    "reply with a brief, friendly greeting (for example, 'Hello, world!'). "
    "If the user greets you personally, you can respond in kind."
)

# ===== SYSTEM PROMPT (for LLM system message) =====
NETWORK_FAULT_SYSTEM_PROMPT = """
...
Return output in the NetworkFaultSummary schema:
